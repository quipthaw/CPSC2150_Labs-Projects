...
public class DoubleDequeApp<T> {
    public static void main(String[] args) {
        ...
        if (a == "1"){ q = new ArrayDeque<Double>(); }
        else q = new ListDeque<Double>();
        ...
        while(b!= "12")
        {
            ...
            if (b.equals("1"))
            {
                ...
                b = myObj3.nextLine();
                q.enqueue(Double.parseDouble(b));
                b = "1";
            }
            ...
            else if(b.equals("7"))
            {
                ...
                else { q.insert(Double.parseDouble(b),Integer.parseInt(pos)); }
                b = "7";
            }
            else if(b.equals("8"))
            {
                ...
                b = myObj3.nextLine();
                Double test = Double.parseDouble(b);
                if(test>q.length() ||  test<1) { System.out.println("Invalid input"); }

                else
                {
                    Double x = q.remove(Integer.parseInt(b));
                    System.out.println("You removed " + x);
                }
                b = "8";
            }
