...
public class TestGameBoardMem
{
    ...
    private IGameBoard Board(int row, int col, int numToWin) {
        ...
        players[0]= 'X';
        players[1] = 'O';
        GameBoardMem fun = new GameBoardMem(row,col,numToWin);
        fun.setPlayers(players);
        return fun;
    }
    ...
    public void test_checkSpace_space_out_of_bounds() {
        ...
        gb.placeMarker(one, 'X');
        gb.placeMarker(two, 'O');
        assertEquals(expected, gb.checkSpace(101, 101));
    }
    ...
    public void test_placeMarker_2players_on_board() {
        ...
        board_mem[2][4] = 'O';
        IGameBoard gb = Board(5, 5, 3);
        BoardPosition curr = new BoardPosition(2, 2);
        BoardPosition second_player = new BoardPosition(2, 4);
        gb.placeMarker(curr, 'X');
        gb.placeMarker(second_player, 'O');
